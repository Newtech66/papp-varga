...
- `DIAGPSD n = Cone of diagonal n x n positive semidefinite matrices`
- `LOGPERSPECEPI n [COMPLEX] = Cone of symmetric (Hermitian) n x n positive semidefinite matrices (T, X, Y) satisfying` $$T \succeq X^{\frac{1}{2}}\log{(X^{\frac{1}{2}}YX^{\frac{1}{2}})}X^{\frac{1}{2}}$$
